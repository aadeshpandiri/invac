...
useHead({
    title: 'InVac Typhoon D2 | Ultimate Central Vacuum Cleaner Solution',
    meta: [
        {
            name: 'description',
            content: "The InVac Typhoon D2 Central Vacuum Cleaner delivers superb performance and efficiency. High-performance suction and smart design for a pristine home environment."
        }
    ]
})
