...
useHead({
    title: 'InVac Techno Plus 230 | Central Vacuum System | Fully Auto Cleaning Solutions',
    meta: [
        {
            name: 'description',
            content: "With InVac Techno Plus 230 Central Vacuum Cleaner, you can achieve superior cleaning. Conveniently designed and efficient. Effortless cleaning for a hygienic living space."
        }
    ]
})
