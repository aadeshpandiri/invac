...
useHead({
    title: 'Powerful Central Vacuum Cleaner for Easy Cleaning | InVac Typhoon Pro T 230',
    meta: [
        {
            name: 'description',
            content: "The InVac Typhoon Pro T 230 Central Vacuum Cleaner will significantly improve your cleaning routine. Your home will appear spotless after cleaning because of its advanced features."
        }
    ]
})
