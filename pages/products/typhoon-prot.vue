...
useHead({
    title: 'Experience Superior Cleaning | InVac Typhoon Pro T Vacuum System',
    meta: [
        {
            name: 'description',
            content: "With the InVac Typhoon Pro T Central Vacuum Cleaner, experience the next level of cleanliness. Superior suction and clever design provide a fresher, cleaner home atmosphere."
        }
    ]
})
