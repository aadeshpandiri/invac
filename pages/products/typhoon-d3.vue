...
useHead({
    title: `InVac Typhoon D3 | Central Vacuum System | Perfect Cleaning Efficiency`,
    meta: [
        {
            name: 'description',
            content: `The InVac Typhoon D3 Central Vacuum Cleaner is the ideal choice for a spotless house. Experience outstanding performance, ease of use, and cleaning in one effective system.`
        }
    ]
})
