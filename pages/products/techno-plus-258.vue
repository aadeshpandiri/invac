...
useHead({
    title: 'InVac Techno Plus 258 | Central Vacuum System | Wet And Dry Central Vacuum System',
    meta: [
        {
            name: 'description',
            content: "Your cleaning performance will be improved with the InVac Techno Plus 258 Central Vacuum Cleaner. Excellent use and functionality for a spotlessly tidy environment."
        }
    ]
})
