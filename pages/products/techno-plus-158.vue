...
useHead({
    title: 'InVac Techno Plus 158 Central Vacuum Cleaner | Efficient Home Cleaning Solutions',
    meta: [
        {
            name: 'description',
            content: "The InVac Techno Plus 158 Central Vacuum Cleaner provides superior cleaning efficiency. It's the solution to a spotless house, designed for speed and simple use."
        }
    ]
})
