...
useHead({
    title: `Squeegee On Wheels | Perfect Window Clean With Central Vacuum | InVac`,
    meta: [
        {
            name: 'description',
            content: `Experience a new level of window cleaning proficiency with our squeegee on wheels. optimized for flawless performance within our advanced central vacuum system.`
        }
    ]
})
const triggerMenu = () => {
