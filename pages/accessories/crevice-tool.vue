...
useHead({
    title: `Reach Every Nook and Cranny |  Central Vacuum System Crevice Attachment | InVac`,
    meta: [
        {
            name: 'description',
            content: `Explore precision cleaning with our specialized crevice tool for central vacuum systems. Perfect for edges, corners, and tight spaces. Reach tight spots effortlessly for clean!`
        }
    ]
})
const triggerMenu = () => {
