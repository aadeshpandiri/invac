...
useHead({
    title: 'Wheel-Free Mop With Horse Hair | Central Vacuum System | InVac',
    meta: [
        {
            name: 'description',
            content: 'With a wheel-free horsehair mop for central vacuum systems, experience the effortless cleaning power. Effortlessly tackle dirt and grime for spotless floors.'
        }
    ]
})
