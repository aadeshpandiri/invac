...
`)
useHead({
    title: 'Effortless Kitchen Cleaning with Our Kick Vac | INVAC',
    meta: [
        {
            name: 'description',
            content: 'Discover essential kick vac for a cleaner kitchen! Explore efficient tools to your cleaning routine effortlessly. Kickvac reduces the need for manual cleaning.'
        }
    ]
})
const triggerMenu = () => {
