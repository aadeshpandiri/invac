...
useHead({
    title: `Central Vacuum Upholstery Tool | Enhance Cleaning Efficiency | InVac`,
    meta: [
        {
            name: 'description',
            content: `With our Upholstery Tool designed specifically for central vacuum systems, ease and precision coincide. Effortlessly bring back the cleanliness of your fabric surfaces and upholstery.`
        }
    ]
})
const triggerMenu = () => {
