...
`)
useHead({
    title: `Drawer Vac For Modern Kitchen Cleaning | InVac`,
    meta: [
        {
            name: 'description',
            content: `With InVac smart Drawer Vac, you can improve your central vacuum system. With its strong suction and convenient accessibility, enjoy hassle-free cleaning.`
        }
    ]
})
const triggerMenu = () => {
