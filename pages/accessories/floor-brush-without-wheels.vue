...
useHead({
    title: `Best Floor Brush-Without Wheels | Central Vacuum Systems | InVac`,
    meta: [
        {
            name: 'description',
            content: `With our floor brush-without wheels for central vacuums, you can clean with control and agility. Easily move over surfaces for an improved clean without the hassle of wheels.`,
        }
    ]
})
const triggerMenu = () => {
