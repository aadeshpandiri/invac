...
const description = ref(`Cabinet Vac is an innovative cleaning solution designed specifically for kitchen cabinets. This compact and powerful vacuum system is installed directly inside cabinets, providing convenient access to suction away dust, crumbs, and other debris that accumulate in hard-to-reach places. With Cabinet Vac, keeping your cabinets clean is effortless, helping to maintain a tidy and hygienic kitchen environment without the need for additional tools or manual effort.
`)
useHead({
    title: `Cabinet Vac | Enhance Your Central Vacuum System | InVac`,
    meta: [
        {
            name: 'description',
            content: `A cabinet vacuum made specifically for central vacuum systems will take your sense of convenience to the next level. Easy cleaning with strong suction power and a compact design`,
        }
    ]
})
const triggerMenu = () => {
