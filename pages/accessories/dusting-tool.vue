...
useHead({
    title: `Premium Dusting Tool Attachment | Central Vacuum Systems | InVac`,
    meta: [
        {
            name: 'description',
            content: `With the specially designed dusting tool included with our central vacuum system, experience easy dusting. Dust every square inch of your house to make it allergy-free and immaculate.`
        }
    ]
})
const triggerMenu = () => {
