...
useHead({
    title: `Gentle Cleaning | Delicate Dust Brush For Central Vacuum Systems | InVac`,
    meta: [
        {
            name: 'description',
            content: `Gently sweep away debris with our delicate dust brush designed for central vacuum systems. Achieve thorough cleaning without risking damage to delicate surfaces.`
        }
    ]
})
const triggerMenu = () => {
