...
`)
useHead({
    title: `Retra Vac Central Vacuum Systems | InVac`,
    meta: [
        {
            name: 'description',
            content: `Experience the future of cleaning with RetraVac, a superior addition to central vacuum systems. Its intuitive design and exceptional power ensure a thorough clean every time.`
        }
    ]
})
const triggerMenu = () => {
