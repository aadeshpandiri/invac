...
useHead({
    title: `Premium Carpet Brush Attachment For Central Vacuums |  InVac`,
    meta: [
        {
            name: 'description',
            content: `With our carpet brush attachment for Central Vacuum System, clean your carpets with ease. With each sweep, feel the impact of thorough cleaning and outstanding performance.`
        }
    ]
})
const triggerMenu = () => {
