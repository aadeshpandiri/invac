...
`)
useHead({
    title: `Efficient Speedy Vac Solutions | Central Vacuum System | InVac`,
    meta: [
        {
            name: 'description',
            content: `Experience effective cleaning with InVac Speedy Vac for central vacuum systems. A quick and potent fix for spotless vehicle garages, wardrobe spaces, and bathrooms.`
        }
    ]
})
const triggerMenu = () => {
