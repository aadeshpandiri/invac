...
useHead({
    title: `Reversible Brush Without Wheels | Central Vacuum System | InVac`,
    meta: [
        {
            name: 'description',
            content: `Explore the uses of your central vacuum system's reversible brush attachment. Smoothly transition between carpet and hard floor cleaning modes for a convenient cleaning experience.`
        }
    ]
})
const triggerMenu = () => {
